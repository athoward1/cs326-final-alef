...
async function updateWorkspaceTitle(req, res){
    ...
    await connectAndRun(db => db.none("UPDATE workspaces SET workspaceid = ($1) WHERE userid = ($2) AND workspaceid = (#3);", [req.body.newworkspaceid, req.body.userid, req.body.workspaceid]));
    res.send("success");
}
